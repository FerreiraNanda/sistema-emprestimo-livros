...
const Home = () => {
    ...
    <section className="section-content">
        ...
        <AddEmployee onBackBtnClickHnd={showListPages} 
        onSubmitClickHnd={addEmployee}/>
        )}

        {shownPage === PageEnum.edit && <EditEmployee data={dataToEdit} onBackBtnClickHnd={showListPages} onUpdateClickHnd={updateData}/>}
    </section>
    </>
    );
}
